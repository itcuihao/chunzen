...
const TranslationTab = () => {
    ...
    const handleToggleFullscreen = () => {
        ...
        (0, vscode_1.postMessage)({ type: 'toggle-panel-fullscreen' });
    };
